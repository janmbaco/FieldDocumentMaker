...
class App {
    ...
    static async loadData(store: Store<AppState>): Promise<void> {
        ...
        try {
            ...
            alert('Mierdaaaaaaaaaaaaaaaaaaaaa!')
            ...
            //  zones = JSON.parse('[{"id":"13f7a18e-76fd-4d62-8572-f86af0dc0241","label":"Hola mundo!","color":"ligthgreen","isVisible":true,"elements":[{"id":"6f2c913f-113d-4f97-8d0e-735c17d3cf10","template":"<p>Hola <field bind=\'Curriculum.Person.Nombre\' style=\'\'></field>!<p>","isVisible":true}]},{"id":"88c7eaec-1819-4cf5-807a-f962f9b9f03b","label":"otra zone","color":"ligthgreen","isVisible":true,"elements":[{"id":"e7e7d11a-aab7-4e97-a666-d363c4d5e8f3","template":"<p>repito el campo <field bind=\'Curriculum.Person.Nombre\' style=\'\'></field>  y añado apellidos <field bind=\'Curriculum.Person.PrimerApellido\' style=\'\'></field><field bind=\'Curriculum.Person.SegundoAPellido\' style=\'\'></field><p>","isVisible":true}]}]')
        }
    }
